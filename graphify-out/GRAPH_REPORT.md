...
## Corpus Check
- 131 files · ~309,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 762 nodes · 1498 edges · 73 communities (39 shown, 34 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d858ab9`
...
Cohesion: 0.07
Nodes (45): ACTIVE_STATUSES, CURRENCY_SYMBOLS, formatDate(), formatMoney(), OrdersAdminList(), OrdersAdminListProps, PAYMENT_METHOD_LABELS, SHIPPING_PROVIDER_LABELS (+37 more)

### Community 1 - "Admin Accounts & Permissions"
Cohesion: 0.07
Nodes (49): AccountsAdminPanelProps, PERMISSION_LABELS, AdminDashboard(), AdminDashboardProps, getInitials(), DELETE(), GET(), PATCH() (+41 more)
...
Cohesion: 0.09
Nodes (36): DELETE(), GET(), POST(), requirePermission(), getClientIp(), POST(), GET(), getClientIp() (+28 more)
...
Cohesion: 0.10
Nodes (30): MessagesAdminListProps, ReviewsAdminList(), ReviewsAdminListProps, DELETE(), GET(), PATCH(), requireAccess(), DELETE() (+22 more)
...
Cohesion: 0.31
Nodes (8): CartContext, CartCtx, CartItem, CartProvider(), fetchDiscount(), itemKey(), PriceRaw, calcDiscount()
...
Cohesion: 0.19
Nodes (12): AdminPage(), GET(), ProduktPage(), fetchFromRedis(), getProductStock(), getStock(), getStockMap(), makeKey() (+4 more)
...
Cohesion: 0.12
Nodes (11): BankovniPrevod(), Snapshot, SnapshotInfo, SnapshotItem, SuccessContent(), buildSpdString(), COMBINING_MARKS, QrPlatbaInput (+3 more)

### Community 20 - "Cart State & Discounts"
Cohesion: 0.13
Nodes (13): KategoriePage(), SITE_URL, sitemap(), STATIC_PAGES, categories, getCategoryBySlug(), MediaItem, ProductColor (+5 more)

### Community 21 - "Order Form (Objednavka)"
Cohesion: 0.15
Nodes (23): InformacePage(), BESTSELLER_SLUGS, COLOR_LABELS, getProductImgs(), KosikPage(), ProductCard(), translateValue(), dopravyOptions (+15 more)
...
Cohesion: 0.32
Nodes (9): POST(), PriceEntry, GET(), getEffectivePrice(), getPriceOverrides(), getProductsWithPriceOverrides(), overrideKey(), setPriceOverridesBulk() (+1 more)
...
- **Why does `dependencies` connect `dependencies` to `react`, `react-dom`, `@stripe/stripe-js`, `xlsx`, `Core NPM Dependencies`, `package.json`, `google-auth-library`?**
