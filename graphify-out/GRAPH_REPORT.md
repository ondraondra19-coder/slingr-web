...
## Corpus Check
- 127 files · ~307,157 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 743 nodes · 1434 edges · 69 communities (36 shown, 33 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cba350e4`
...
Cohesion: 0.08
Nodes (38): ACTIVE_STATUSES, CURRENCY_SYMBOLS, formatDate(), formatMoney(), OrdersAdminList(), OrdersAdminListProps, PAYMENT_METHOD_LABELS, SHIPPING_PROVIDER_LABELS (+30 more)
...
Cohesion: 0.11
Nodes (28): POST(), PriceEntry, getClientIp(), POST(), getClientIp(), POST(), GET(), benefits (+20 more)
...
Cohesion: 0.10
Nodes (21): formatPrice(), normalizePrice(), priceEquals(), ProductsAdminList(), ProductsAdminListProps, KategoriePage(), SITE_URL, sitemap() (+13 more)
...
Cohesion: 0.08
Nodes (35): ReviewsAdminList(), ReviewsAdminListProps, DELETE(), POST(), StockEntryInput, GET(), POST(), GET() (+27 more)
...
Cohesion: 0.16
Nodes (19): DiscountWidget(), CartContext, CartCtx, CartItem, CartProvider(), itemKey(), PriceRaw, APPROX_RATES (+11 more)

### Community 21 - "Order Form (Objednavka)"
Cohesion: 0.21
Nodes (15): BESTSELLER_SLUGS, COLOR_LABELS, getProductImgs(), KosikPage(), ProductCard(), translateValue(), ObjednavkaPage(), SuccessContent() (+7 more)
...
Cohesion: 0.19
Nodes (14): MessagesAdminListProps, DELETE(), GET(), PATCH(), requireAccess(), getClientIp(), POST(), addMessage() (+6 more)
